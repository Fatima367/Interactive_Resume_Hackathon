            ...
            shareButton.addEventListener("click", function () {
                ...
                copybtn.addEventListener("click", function () {
                    navigator.clipboard
                        ...
                        .catch(function (err) {
                        return console.error("Copy Link by right click on underlined text!", err);
                    });
                });
            });
