...
function handleShareButtonClick(shareButton, shareLinks) {
...
function displayResume(resumeContainer, formDiv, resumeData, imageSrc) {
...
function handleFormSubmit(event) {
    ...
    if ((_a = data.image.files) === null || _a === void 0 ? void 0 : _a[0]) {
